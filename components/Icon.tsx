...
const icons: { [key: string]: React.JSX.Element } = {
  ...
  flag: <path strokeLinecap="round" strokeLinejoin="round" d="M3 3v1.5M3 21v-6m0 0l2.77-.693a9 9 0 016.208.682l.108.054a9 9 0 006.086.71l3.114-.732a48.524 48.524 0 01-.005-104.499l-3.11.732a9 9 0 01-6.085-.711l-.108-.054a9 9 0 00-6.208-.682L3 4.5M3 15V4.5" />,
  ...
  award: <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9m9 0a3 3 0 013 3h-15a3 3 0 013-3m9 0v-3.375c0-.621-.503-1.125-1.125-1.125h-.871M7.5 18.75v-3.375c0-.621.504-1.125 1.125-1.125h.872m5.007 0H9.497m5.007 0a7.494 7.494 0 013.338-4.791 4.875 4.875 0 00-5.223-8.103 4.875 4.875 0 00-8.292 2.354 4.875 4.875 0 00.167 8.665 7.494 7.494 0 013.338 4.79" />,
  ...
  play: <path strokeLinecap="round" strokeLinejoin="round" d="M5.25 5.653c0-.856.917-1.398 1.667-.986l11.54 6.348a1.125 1.125 0 010 1.971l-11.54 6.347c-.75.412-1.667-.13-1.667-.986V5.653z" />,
  ...
  music: <path strokeLinecap="round" strokeLinejoin="round" d="M9 9l10.5-3m0 6.553v3.75a2.25 2.25 0 01-1.632 2.163l-1.32.377a1.803 1.803 0 11-.99-3.467l.124-.035a1.121 1.121 0 00.818-.808V12m0 0l-9 3m0 0v3.75a2.25 2.25 0 01-1.632 2.163l-1.32.377a1.803 1.803 0 11-.99-3.467l.124-.035a1.121 1.121 0 00.818-.808V15" />,
  ...
  palette: <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4 2.245 4.5 4.5 0 008.4-2.245c0-.399-.078-.78-.22-1.128zm0 0a15.998 15.998 0 003.388-1.62m-5.04.64a15.9 15.9 0 013.388-1.62m-3.388 1.62L9 21m3 0h3m-3 0l-1.361-4.89m5.889 5.39a3 3 0 011.94-3.53a4.47 4.47 0 00-1.61-3.39m0 0A15.912 15.912 0 0112 13.5m4.501 1.128c.413 1.4 1.712 2.25 3.116 1.932m0 0a3 3 0 00-1.128-5.78" />,
  'vaulting-horse': <path strokeLinecap="round" strokeLinejoin="round" d="M4 11h16M4 11l-1 10m17-10l1 10M12 11V3m0 0a2 2 0 100 4 2 2 0 100-4zM6 11V7a2 2 0 012-2h8a2 2 0 012 2v4" />,
  brush: <path strokeLinecap="round" strokeLinejoin="round" d="M14.5 3.5c1 1 1 2.5 0 3.5L8 13.5H4v-4L10.5 3c1-1 2.5-1 3.5 0z M4 9.5L14.5 20 M16 4.5L19.5 8" />,
  ...
  algebra: (
    <g fill="none" stroke="currentColor" strokeWidth="1.5">
      <path strokeLinecap="round" strokeLinejoin="round" d="M16 8c0 3.167-2.667 5-4 8m0-8c1.333 3 4 4.833 4 8" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M8 8c0 3.167 2.667 5 4 8m0-8c-1.333 3-4 4.833-4 8" />
    </g>
  ),
  variable: (
    <g fill="none" stroke="currentColor" strokeWidth="1.5">
      <path strokeLinecap="round" strokeLinejoin="round" d="M8 8l8 8m0-8L8 16" />
    </g>
  ),
  equal: (
    <g fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  'trending-up': <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18L9 11.25l4.5 4.5L21.75 7.5M21.75 7.5V12m0-4.5H17.25" />,
  shapes: (
    <g fill="none" stroke="currentColor" strokeWidth="1.5">
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 3l4 7H8l4-7zM4 14h6v6H4v-6zM14 17a3 3 0 116 0 3 3 0 01-6 0z" />
    </g>
  ),
  ...
  'user-plus': <path strokeLinecap="round" strokeLinejoin="round" d="M18 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-3a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM3 19.235v-.11a6.375 6.375 0 0112.75 0v.11" />,
  ...
  key: <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 5.25a3 3 0 013 3m3 0a6 6 0 01-7.03 5.903L9 16.5v2.25h-2.25v2.25H3v-3.118l6.314-6.313a6 6 0 018.436-8.437z" />,
  'alert-circle': <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m9-.75a9 9 0 11-18 0 9 9 0 0118 0zm-9 3.75h.008v.008H12v-.008z" />,
};
